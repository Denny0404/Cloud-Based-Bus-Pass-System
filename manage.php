...
function verifyPassword($row, $inputPassword) {
    return isset($row['password']) && $row['password'] === $inputPassword;
}
...
<div class="site-wrap">
    ...
    <left>
        <form class="print" action="manage.php" method="post" style="margin-top:75px; margin-left: 75px">
            ...
            PASSWORD: <input type="password" id="pass_id" style="height:35px;" name="password" required>
            <input type="submit" class="btn btn-primary py-1 px-5 text-white" value="Search">
        </form>
    </left>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-4 mb-3 bg-white">
                            ...
                            <p class="mb-4">GLA University - <?php echo $row['dest']; ?></p>
